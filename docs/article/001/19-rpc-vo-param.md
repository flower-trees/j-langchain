...
> **标签**：`Java` `Agent` `j-langchain` `RPC` `Dubbo` `Feign` `@AgentTool` `@Param` `@ParamDesc`  
...
对应 [`dubboAgentDemo()`](../../../src/test/java/org/salt/jlangchain/demo/article/Article19RpcMcpTools.java)：
...
对应 [`feignAgentDemo()`](../../../src/test/java/org/salt/jlangchain/demo/article/Article19RpcMcpTools.java)：
...
> 完整示例：[Article19RpcMcpTools.java](../../../src/test/java/org/salt/jlangchain/demo/article/Article19RpcMcpTools.java)

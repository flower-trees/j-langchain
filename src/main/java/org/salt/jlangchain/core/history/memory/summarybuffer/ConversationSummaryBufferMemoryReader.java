...
/**
 * Returns all stored entries: [Summary (if any), recentTurn1, recentTurn2, ...].
 * The summary is rendered as a SystemMessage by {@link org.salt.jlangchain.core.history.HistoryReaderBase}.
 */
@Slf4j
@Data
@EqualsAndHashCode(callSuper = true)
public class ConversationSummaryBufferMemoryReader extends ConversationMemoryReaderBase {
    ...
    public static final class Builder {
        ...
        public ConversationSummaryBufferMemoryReader build() {
            ConversationSummaryBufferMemoryReader r = new ConversationSummaryBufferMemoryReader();

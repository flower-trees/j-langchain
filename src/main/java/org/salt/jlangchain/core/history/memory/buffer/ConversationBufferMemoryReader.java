...
/**
 * Reads the most recent {@code limit} turns from an unbounded buffer.
 * All turns are retained in storage; only the tail is injected into the prompt.
 * Pair with {@link ConversationBufferMemoryStorer}.
 */
@Slf4j
@Data
@EqualsAndHashCode(callSuper = true)
public class ConversationBufferMemoryReader extends ConversationMemoryReaderBase {
    ...
    public static final class Builder {
        ...
        public ConversationBufferMemoryReader build() {
            ConversationBufferMemoryReader r = new ConversationBufferMemoryReader();

...
package org.salt.jlangchain.core.llm.zhipu;
...
public class ChatZhipu extends BaseChatModel {
    ...
    public static ChatZhipuBuilder<?, ?> builder() {
        return new ChatZhipuBuilderImpl();
    }

    public static abstract class ChatZhipuBuilder<C extends ChatZhipu, B extends ChatZhipuBuilder<C, B>> {
        ...
        public String toString() {
            return "ChatZhipu.ChatZhipuBuilder(vendor=" + this.vendor + ", modelType=" + this.modelType + ", model=" + this.model + ", temperature=" + this.temperature + ", modelKwargs=" + this.modelKwargs + ", tools=" + this.tools + ")";
        }
    }

    private static final class ChatZhipuBuilderImpl extends ChatZhipuBuilder<ChatZhipu, ChatZhipuBuilderImpl> {
        private ChatZhipuBuilderImpl() {
        }

        @Override
        protected ChatZhipuBuilderImpl self() {
            return this;
        }

        @Override
        public ChatZhipu build() {
            return new ChatZhipu(this);
        }
    }

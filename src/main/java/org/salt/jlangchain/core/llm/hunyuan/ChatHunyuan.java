...
package org.salt.jlangchain.core.llm.hunyuan;
...
@Data
public class ChatHunyuan extends BaseChatModel {

    public ChatHunyuan() {
        this.vendor = "hunyuan";
        this.model = "hunyuan-turbo";
    }

    protected ChatHunyuan(ChatHunyuanBuilder<?, ?> builder) {
        super();
        this.vendor = "hunyuan";
        this.model = "hunyuan-turbo";
    ...
    public static ChatHunyuanBuilder<?, ?> builder() {
        return new ChatHunyuanBuilderImpl();
    }

    public static abstract class ChatHunyuanBuilder<C extends ChatHunyuan, B extends ChatHunyuanBuilder<C, B>> {
        ...
        public String toString() {
            return "ChatHunyuan.ChatHunyuanBuilder(vendor=" + this.vendor + ", modelType=" + this.modelType + ", model=" + this.model + ", temperature=" + this.temperature + ", modelKwargs=" + this.modelKwargs + ", tools=" + this.tools + ")";
        }
    }

    private static final class ChatHunyuanBuilderImpl extends ChatHunyuanBuilder<ChatHunyuan, ChatHunyuanBuilderImpl> {
        private ChatHunyuanBuilderImpl() {
        }

        @Override
        protected ChatHunyuanBuilderImpl self() {
            return this;
        }

        @Override
        public ChatHunyuan build() {
            return new ChatHunyuan(this);
        }
    }
    ...
    public BaseChatModel withJsonMode() {
        ChatHunyuan copy = (ChatHunyuan) copy();
        copy.jsonMode = true;
        return copy;
    }

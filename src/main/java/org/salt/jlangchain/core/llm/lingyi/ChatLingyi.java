...
package org.salt.jlangchain.core.llm.lingyi;
...
public class ChatLingyi extends BaseChatModel {
    ...
    public static ChatLingyiBuilder<?, ?> builder() {
        return new ChatLingyiBuilderImpl();
    }

    public static abstract class ChatLingyiBuilder<C extends ChatLingyi, B extends ChatLingyiBuilder<C, B>> {
        ...
        public String toString() {
            return "ChatLingyi.ChatLingyiBuilder(vendor=" + this.vendor + ", modelType=" + this.modelType + ", model=" + this.model + ", temperature=" + this.temperature + ", modelKwargs=" + this.modelKwargs + ", tools=" + this.tools + ")";
        }
    }

    private static final class ChatLingyiBuilderImpl extends ChatLingyiBuilder<ChatLingyi, ChatLingyiBuilderImpl> {
        private ChatLingyiBuilderImpl() {
        }

        @Override
        protected ChatLingyiBuilderImpl self() {
            return this;
        }

        @Override
        public ChatLingyi build() {
            return new ChatLingyi(this);
        }
    }
    ...
    public BaseChatModel withJsonMode() {
        ChatLingyi copy = (ChatLingyi) copy();
        copy.jsonMode = true;
        return copy;
    }

...
public abstract class SseBaseAiChatActuator<O, I> implements AiChatActuator {
    ...
    protected abstract SseListenerStrategy getListenerStrategy(AiChatInput aiChatInput, Consumer<AiChatOutput> responder, BiConsumer<AiChatInput, AiChatOutput> callback);

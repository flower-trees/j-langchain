...
public abstract class SseDoListener implements SseListenerStrategy {
    ...
    public SseDoListener(AiChatInput aiChatInput, Consumer<AiChatOutput> responder, BiConsumer<AiChatInput, AiChatOutput> completeCallback) {
    ...
    public void onMessage(String event, String msg) {
        ...
        AiChatOutput aiChatOutput = convertMsg(event, msg);
        if (aiChatOutput == null) {
            return;
        }
    ...
    protected abstract AiChatOutput convertMsg(String event, String msg);

...
import org.salt.jlangchain.ai.vendor.doubao.param.DoubaoResponse;
...
public class DoubaoListener extends DoListener {
    ...
    public DoubaoListener(AiChatInput aiChatInput, Consumer<AiChatOutput> responder, BiConsumer<AiChatInput, AiChatOutput> callback) {
    ...
    private static @NotNull List<AiChatOutput.Message> getMessages(DoubaoResponse response) {
